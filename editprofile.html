...
<body>
    <div class="container" style="max-width:1000px; margin:0 auto;">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                    ...
                                    <img class="story-icon-main" src="./img/photo-1607670055106-e9280ef1c405.jpg"
        ...
        <div class="comment">In most cases, you'll be able to change your username back to lth_1001 for another 14 days.</div>
        <div class="input-group input-group-sm mb-3">
        ...
        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
            ...
            <label class="btn btn-outline-primary" for="btncheck1">Submit</label>
        </div>
        </div>
    </div>
