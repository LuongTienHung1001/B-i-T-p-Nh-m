<div class="container-fluid px-0" style="">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container py-3" style=" padding: 0 100px; height: 70px;">
                <a class="navbar-brand flex-grow-1" href="homepage.php">𝓘𝓷𝓽𝓪𝓻𝓰𝓻𝓪𝓶</a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <div class="d-flex align-items-center">
                            <a  href="homepage.php" class="px-3"><svg aria-label="Home" class="_8-yf5 " color="#262626" fill="#262626"
                            ...
                            <a href="#" id="btn_hienthi_messenger" class="px-3"><svg aria-label="Messenger" class="_8-yf5 " color="#262626" fill="#262626"
                                    height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <path
                            ...
                            <a href="#" class="px-3"><svg aria-label="New Post" class="_8-yf5 " color="#262626" fill="#262626"
                                    height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <path
                            ...
                            <a href="#" class="px-3"><svg aria-label="Find People" class="_8-yf5 " color="#262626" fill="#262626"
                                    height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <polygon fill="none"
                            ...
                            <a href="#" id="btn_hienthi_thongbao" class="px-3"><svg aria-label="Activity Feed" class="_8-yf5 " color="#262626" fill="#262626"
                                    height="24" role="img" viewBox="0 0 24 24" width="24">
                                    <path
